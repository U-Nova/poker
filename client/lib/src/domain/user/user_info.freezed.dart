...
mixin _$UserInfo {
 ...
 String get id; String get name; UserIcon get icon;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserInfo&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon));
}
...
@override
String toString() {
  return 'UserInfo(id: $id, name: $name, icon: $icon)';
}
...
@useResult
$Res call({
 String id, String name, UserIcon icon
});
...
class _UserInfo extends UserInfo {
  const _UserInfo({required this.id, this.name = "ゲストプレイヤー", this.icon = UserIcon.default_1}): super._();
  factory _UserInfo.fromJson(Map<String, dynamic> json) => _$UserInfoFromJson(json);

@override final  String id;
@override@JsonKey() final  String name;
@override@JsonKey() final  UserIcon icon;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserInfo&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon));
}
