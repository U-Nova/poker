...
mixin _$Game {
 ...
 String get id; Deck get deck; List<Player> get players; List<Round> get rounds; int get pods; String get buttonPlayerId;
...
@override
String toString() {
  return 'Game(id: $id, deck: $deck, players: $players, rounds: $rounds, pods: $pods, buttonPlayerId: $buttonPlayerId)';
}
...
@useResult
$Res call({
 String id, Deck deck, List<Player> players, List<Round> rounds, int pods, String buttonPlayerId
});
